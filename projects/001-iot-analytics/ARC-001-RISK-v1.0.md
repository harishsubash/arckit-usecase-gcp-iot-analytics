...
This is the initial risk register (v1.0), raised at the Platform Design stage. It will be reviewed at the end of each rollout phase (see `ARC-001-STRAT-v1.0`) and re-scored based on pilot-depot evidence — several likelihoods above (notably R-005 and R-006) are expected to fall once real depot data is available for tuning.
