...
|---|---|
| [`ARC-001-STKE-v1.0.md`](./ARC-001-STKE-v1.0.md) | Stakeholder analysis — who is affected and how they're engaged, including driver privacy considerations |
| [`ARC-001-REQ-v1.0.md`](./ARC-001-REQ-v1.0.md) | Functional and non-functional requirements, MoSCoW-prioritised |
| [`ARC-001-RISK-v1.0.md`](./ARC-001-RISK-v1.0.md) | Risk register covering data loss, cost, privacy, and connectivity risks |
| [`ARC-001-SOBC-v1.0.md`](./ARC-001-SOBC-v1.0.md) | Business case — strategic, economic, commercial, financial, and management cases |
| [`ARC-001-STRAT-v1.0.md`](./ARC-001-STRAT-v1.0.md) | Architecture strategy — target state and phased, depot-by-depot migration approach |
| [`ARC-001-PLAT-v1.0.md`](./ARC-001-PLAT-v1.0.md) | Platform design — full architecture with diagrams, component detail, scaling and cost controls |
| [`decisions/ARC-001-ADR-001-v1.0.md`](./decisions/ARC-001-ADR-001-v1.0.md) | ADR: Pub/Sub + Dataflow over self-managed Kafka + Flink |
| [`decisions/ARC-001-ADR-002-v1.0.md`](./decisions/ARC-001-ADR-002-v1.0.md) | ADR: Bigtable for current-vehicle-state serving over querying BigQuery directly |

Global architecture principles applicable to this project are in [`../000-global/ARC-000-PRIN-v1.0.md`](../000-global/ARC-000-PRIN-v1.0.md).
