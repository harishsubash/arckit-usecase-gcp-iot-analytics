...
- **No wave proceeds until the previous wave's risk register review (`ARC-001-RISK-v1.0`) shows no open High-severity items.**
...
- **Driver communication and, where applicable, worker-representative consultation completes before a depot's vehicles start streaming location data** — this is a hard gate, not a parallel-track activity (Principle P6, `ARC-001-STKE-v1.0`).
