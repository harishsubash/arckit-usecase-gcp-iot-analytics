...
The financial case will be revisited with real depot cost/benefit data after Phase 1 (see `ARC-001-STRAT-v1.0`), rather than relying solely on these pre-pilot estimates.
...
Governance: fortnightly steering review (Head of Fleet Operations, Data & Analytics Team, IT Platform Engineering) per the RACI in `ARC-001-STKE-v1.0`.
